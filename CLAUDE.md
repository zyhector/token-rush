...
| 3 (2–3 wk) | Speculation fused into the graph: MTP chain/tree vs 4-bit DSpark, acceptance-driven dynamic depth; greedy speculative output identical to greedy raw output. **MTP chain done 2026-09-08** (`docs/progress.md` steps 12–14): 183 / 254 / 258 tok/s effective on prose / code / math, exact vs raw greedy with shared kernels; tree, DSpark, sampling still open | Effective-throughput headline |
