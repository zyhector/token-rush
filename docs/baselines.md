...
engines were swept the following night at 0 / 8k / 16k / 32k / 64k / 96k /
128k / 160k / 200k / 240k — `results/2026-09-09-machine-36542/sweep10/`
(`sweep10.csv`, 116 rows, regenerated by `scripts/sweep_table.py`; the
README there says what fit and what did not). tok/s (% of the wall on each
engine's own bytes):

| engine / config | 0 | 8k | 16k | 32k | 64k | 96k | 128k | 160k | 200k | 240k |
|---|---|---|---|---|---|---|---|---|---|---|
| **Token Rush**, raw, Triton GEMV | **101** (81%) | 99 (81%) | 97 (81%) | 94 (82%) | 89 (82%) | 84 (83%) | 80 (84%) | 76 (85%) | **72** (85%) | **68** (86%) |
| Token Rush, raw, Marlin layout | 97 (78%) | 96 (78%) | 94 (79%) | 92 (79%) | 86 (80%) | 82 (81%) | 78 (82%) | 74 (82%) | 70 (83%) | 66 (84%) |
| vLLM, raw | 78 (74%) | 77 (75%) | 77 (76%) | 75 (77%) | 72 (77%) | 69 (78%) | 66 (79%) | 63 (80%) | 60 (80%) | 57 (81%) |
| llama.cpp, raw | 81 (74%) | 80 (73%) | 77 (72%) | 71 (69%) | 65 (68%) | 59 (65%) | 54 (63%) | 50 (61%) | 45 (59%) | 41 (57%) |
| ExLlamaV3, raw | 77 (60%) | 75 (61%) | 73 (61%) | 70 (63%) | 64 (66%) | 59 (68%) | 55 (70%) | 52 (72%) | 48 (74%) | — |
| SGLang, raw | 63 (60%) | 62 (60%) | 61 (60%) | 60 (61%) | 58 (62%) | 56 (63%) | 54 (64%) | 52 (65%) | 50 (67%) | 48 (68%) |
| Token Rush, spec, MTP chain, prose | 266 | 270 | 236 | 210 | 187 | 184 | 169 | 191 | 198 | 160 |
| Token Rush, spec, DFlash2, prose | 279 | 280 | 205 | 164 | 143 | 130 | 120 | 147 | 189 | 121 |
| Token Rush, spec, MTP chain, code | 356 | 358 | 286 | 243 | 232 | 258 | 195 | 239 | 165 | 231 |
| Token Rush, spec, DFlash2, code | 479 | 457 | 354 | 274 | 201 | 335 | 155 | 281 | 107 | 237 |
| llama.cpp, MTP x1, prose | 138 | 132 | 146 | 116 | 102 | 97 | 75 | 71 | 70 | 64 |
| ExLlamaV3, MTP x2 | 171 | 166 | 108 | 122 | 96 | 127 | 91 | — | — | — |

Two things the dense rows show that four points could not. Every engine's
raw curve is smooth and monotone, and the *fraction* of the wall separates
them cleanly: ours rises 81 → 86%, vLLM 74 → 81%, SGLang 60 → 68%,
ExLlamaV3 60 → 74%, llama.cpp falls 74 → 57% — so at 240k we decode 68
tok/s against vLLM's 57 and llama.cpp's 41. And the speculative rows are
*not* smooth in tok/s because acceptance is a property of the text at each
position (2.4–4.4 per step over a 200-token continuation), while the step
cost underneath is smooth: our MTP-chain step goes 12.6 → 18.5 ms and the
DFlash2 step 13.8 → 24.9 ms from 0 to 240k (`engine_spec_*.log`). llama.cpp's
MTP loses its gain with context faster than its raw decode loses speed
(138 → 64 against 81 → 41); ExLlamaV3's chained MTP stops fitting at 160k.
